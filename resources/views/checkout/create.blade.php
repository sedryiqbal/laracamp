                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{route('checkout.store', $camps->id)}}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="accupation" type="text" class="form-control {{$errors->has('accupation') ? 'is-invalid' : ' '}}" value="{{old('accupation') ?: Auth::user()->accupation}}" required/>
                                    @if($errors->has('accupation'))
                                        <p class="text-danger">{{$errors->first('accupation')}} </p>
                                    @endif                               
                                </div>
                                <div class="mb-4">
